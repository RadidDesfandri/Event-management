...
import FormikLoginEO from "@/components/login/formikLoginEO";
        ...
        <div className='w-screen h-screen'>
            ...
            <div className="flex w-full justify-between py-28">
                ...
                <div className="flex flex-col h-96 w-1/2 justify-center items-center ">
                    ...
                    <p className="pb-3">tidak mempunyai akun? <Link href={'/registerEO'} className="text-blue-800 font-bold">Daftar</Link></p>
