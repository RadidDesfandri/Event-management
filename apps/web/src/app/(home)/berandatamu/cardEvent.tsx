  ...
  return (
    ...
    <div className=' md:justify-between md:flex md:flex-wrap gap-2  '>
      {dataEvent.map((item, key) => (
        <div key={key} className='h-full w-[260px] pb-2 bg-gray-800 backdrop-blur-2xl mb-5 md:mb-0 rounded-lg overflow-hidden relative hover:scale-95 transition-all duration-200 shadow-sm shadow-blue-500/50'>
          ...
          <div className='px-4 py-3'>
            ...
            <span className='w-[230px] h-[1px] bg-gray-400 block'></span>
