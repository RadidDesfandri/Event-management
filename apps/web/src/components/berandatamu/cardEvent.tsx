  ...
  return (
    ...
    <div className=' md:justify-between md:flex md:flex-wrap gap-2  '>
      {dataEvent.map((item, key) => (
        <div key={key} className='h-full w-[350px] md:w-[320px] lg:w-[260px] pb-2 bg-gray-800 backdrop-blur-2xl mb-5 md:mb-0 rounded-lg overflow-hidden relative hover:scale-95 transition-all duration-200 shadow-sm shadow-blue-500/50'>
